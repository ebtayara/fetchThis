...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Tasks', [
      { name:'Picking up 💩',description:'taking care of business', userId:1, listId:1, completed:true, createdAt:new Date(), updatedAt:new Date() },
      ...
      { name:'Grooming',description:'taking care of business', userId:1, listId:1, completed:true, createdAt:new Date(), updatedAt:new Date() },
      ...
      { name:'Picking up 💩',description:'taking care of business', userId:2, listId:1, completed:true, createdAt:new Date(), updatedAt:new Date() },
      ...
      { name:'Feeding',description:'taking care of business', userId:2, listId:1, completed:true, createdAt:new Date(), updatedAt:new Date() },
